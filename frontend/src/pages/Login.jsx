...
const Login = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-950 min-h-screen py-24 px-4 sm:px-6 lg:px-12 flex items-center justify-center transition-colors duration-300">
      ...
      <div className="bg-white dark:bg-gray-900 p-12 lg:p-16 rounded-[3.5rem] shadow-2xl w-full max-w-lg border border-gray-100 dark:border-gray-800 animate-in zoom-in-95 duration-700 relative overflow-hidden">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-black text-gray-900 dark:text-white tracking-tighter mb-4">{t("login_title") || "Welcome Back"}</h1>
          <p className="text-gray-500 dark:text-gray-400 font-medium text-lg">{t("login_subtitle") || "Sign in to your BookVerse account"}</p>
        </div>
        
        {error && (
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800 text-red-600 dark:text-red-400 p-6 rounded-3xl mb-10 animate-in slide-in-from-top-4 duration-500" role="alert">
            <p className="font-black text-[10px] uppercase tracking-widest mb-1">{t("login_failed") || "Login Failed"}</p>
        ...
        <form onSubmit={submitHandler} className="space-y-8">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center ml-4 rtl:mr-4 rtl:ml-0">
              <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest" htmlFor="password">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-5 px-8 rounded-[1.5rem] font-black text-xs uppercase tracking-widest shadow-2xl transition-all active:scale-95 flex items-center justify-center gap-4 ${
          ...
          >
            ...
            {loading ? t("signing_in") || 'Signing in...' : t("sign_in_btn") || 'Sign In'}
          </button>
        </form>
