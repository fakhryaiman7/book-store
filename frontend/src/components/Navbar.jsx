          ...
          <div className="hidden md:flex items-center space-x-3 rtl:space-x-reverse">
            ...
            {user ? (
              <>
                ...
                {/* User logout button only, avatar removed */}
                <button
            ...
            <div className="border-t border-gray-100 dark:border-gray-800 pt-3 mt-2 flex flex-col space-y-1">
              ...
              {user ? (
                <>
                  ...
                  <Link to="/profile" onClick={() => setIsMenuOpen(false)} className="px-4 py-2.5 text-sm font-semibold text-gray-600 dark:text-gray-400 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800">{t("nav_profile") || "Profile"}</Link>
                  {(user.isAdmin || user.role === "admin" || user.isAuthor || user.role === "author") && (
